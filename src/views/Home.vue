        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 Desde los requerimientos iniciales hasta el diseño final, comprender cómo se representa un sistema es clave para desarrollar soluciones tecnológicas funcionales y eficaces. En esta unidad, se explora el modelado de sistemas como una herramienta fundamental que permite visualizar, estructurar y validar el funcionamiento de un #[em software] antes de su construcción. A través del uso de diagramas UML, se aprenderá a traducir requisitos en representaciones gráficas claras, facilitando la comunicación entre usuarios, analistas y desarrolladores.
              
              p #[b ¡Prepárese para afrontar los retos del análisis y diseño de software con confianza y eficacia!]
